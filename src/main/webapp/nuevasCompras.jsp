            ...
            <section>
                <div class="container">
                    <div class="dynamicContent">
                        ...
                        <h1>Sistema de Compras online</h1>
                        <h3>bienvenido a nuesro sistema de compras solo esta permitido maximo de 4 compras </h3>
                        <%
                        ...
                        <form action=" ComprasInternet" method="post">
                            <div class="form_settings">
                                ...
                                <p><span>Nombre Cliente</span>
                                 ...
                                 <p><span>Numero de tarjeta</span>
                                    <input class="contact" type="text" name="tarjeta" value="" /></p>
                                
                                <p><span>Libro 1</span>
                                    <select class="contact" name="libro1" >
...
b                                        <h1>inserte un Libro</h1>
                                        ...
                                        <p><span>Libro 2</span>
                                    <select class="contact" name="libro2" >
                                        <%                            //Si la variable que me deben enviar existe  
                                            if (request.getAttribute("lis") != null) {
                                                //Capturando informacion variable que me estan enviado.    
                                                ArrayList<Libro> esquemas = (ArrayList<Libro>) request.getAttribute("lis");
...
b                                        <h1>inserte un Libro</h1>
                                        ...
                                        <p><span>Libro 3</span>
                                    <select class="contact" name="libro3" >
                                        <%                            //Si la variable que me deben enviar existe  
                                            if (request.getAttribute("lis") != null) {
                                                //Capturando informacion variable que me estan enviado.    
                                                ArrayList<Libro> esquemas = (ArrayList<Libro>) request.getAttribute("lis");
...
b                                        <h1>inserte un Libro</h1>
                                        ...
                                        <p><span>Libro 4</span>
                                    <select class="contact" name="libro4" >
                                        <%                            //Si la variable que me deben enviar existe  
                                            if (request.getAttribute("lis") != null) {
                                                //Capturando informacion variable que me estan enviado.    
                                                ArrayList<Libro> esquemas = (ArrayList<Libro>) request.getAttribute("lis");
